...
class getRegistrationFormTypeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Form/RolesTransformer.php';

        return $container->privates['App\\Form\\RegistrationFormType'] = new \App\Form\RegistrationFormType(new \App\Form\RolesTransformer());
    }
}
