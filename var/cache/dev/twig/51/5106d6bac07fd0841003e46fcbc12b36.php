...
class __TwigTemplate_f5a9c753b908a23b34c0eccf66dccd8e extends Template
{
    private $source;
    private $macros = [];
...
<div style=\"margin: auto; width: 20%;\">
    ...
    ";
        ...
        yield "
        <label for=\"registration_form_roles\" class=\"required\">Roles</label>
        ";
        // line 23
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 23, $this->source); })()), "roles", [], "any", false, false, false, 23), 'widget');
        yield "
        ";
        // line 24
...
";
    ...
    {
        return array (  140 => 31,  134 => 28,  131 => 27,  129 => 25,  125 => 24,  121 => 23,  116 => 21,  112 => 20,  108 => 19,  103 => 17,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "/Applications/MAMP/htdocs/CRM/CRM_project_1/templates/registration/register.html.twig");
    }
}
